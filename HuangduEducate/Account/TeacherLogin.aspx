<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherLogin.aspx.cs" Inherits="Account_TeacherLogin" %>
...
<body>
    ...
    <form id="form1" class="login-form" runat="server"> 
                <asp:TextBox ID="teacherID_TB" placeholder="教师用户名" runat="server"></asp:TextBox> <br />
